-- ============================================================================
-- Des Moines Eclipse Volleyball Stat Tracker - Database Setup
-- ============================================================================
...
CREATE TABLE matches (
    match_id TIMESTAMPTZ PRIMARY KEY DEFAULT NOW(),
    tournament TEXT,
...
COMMENT ON COLUMN matches.match_id IS 'Unique identifier - timestamp when match was created';
...
CREATE TABLE set_scores (
    ...
    match_id TIMESTAMPTZ NOT NULL REFERENCES matches(match_id) ON DELETE CASCADE,
...
COMMENT ON TABLE set_scores IS 'Scores and stats for each saved set';
...
COMMENT ON COLUMN player_stats.team_name IS 'Team affiliation - future-proofed for multi-team support';
...
-- Create policies that allow public access (since this is a team app)
